    ...
    async function submitOrder(data: FieldValues) {
        ...
        try {
            ...
            if (paymentResult.paymentIntent?.status === "succeeded") {
                ...
                setPaymentMessage("Your payment was successful. Please sit back and relax!");
                        ...
                        <>
                            ...
                            {paymentSucceeded ? (
                                <Typography variant="subtitle1">
                                    Your order number is #{orderNumber}. Please check "My Orders" under your profile to see the status and details of your order!
                                </Typography>
                            ) : (
